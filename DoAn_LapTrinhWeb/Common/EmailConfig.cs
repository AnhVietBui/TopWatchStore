...
namespace DoAn_LapTrinhWeb.Common
{
    public class EmailConfig
    {
         ...
         */
        public const string emailID = "vbui19965@gmail.com";
        public const string emailPassword = "ylrikqdtcyhuevls";
        public const string emailHost = "smtp.gmail.com"; //nếu dùng gmail thì đổi thành  "Host = "smtp.gmail.com"
        public const string emailName = "Đồng Hồ TopWatch";//Tên email hiển thị khi gửi
    }
