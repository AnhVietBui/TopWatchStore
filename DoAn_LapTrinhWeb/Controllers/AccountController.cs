...
namespace DoAn_LapTrinhWeb.Controllers
{
    public class AccountController : Controller
    {
        ...
        public ActionResult Home()
        {
            ...
            ViewBag.Watch = db.Products.Where(item => item.status == "1" && item.type == 1 && item.quantity != "0").OrderByDescending(item => item.buyturn + item.view).Take(8).ToList();
       ...
       [HttpPost]
        ...
        public ActionResult Register(RegisterViewModels model,Account account)
        {
            ...
            account.Avatar = "/Content/Images/logo/topwatchicon.png";
